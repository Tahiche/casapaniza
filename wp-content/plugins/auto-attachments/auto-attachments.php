...
function aa_admin_page( ) {
				add_menu_page(__('Auto Attachments', 'autoa'), __('Auto Attachments', 'autoa'), '10', 'auto_attachments', 'aa_settings', plugins_url('auto-attachments/includes/images/aamenu.png'));
}
...
function aa_settings( ) {
				...
				if ($_POST['serkoup'] == 'uppo') {
					...
					$check_opt = array ('mp3_listen','video_watch','before_title','show_b_title','showmp3info','showvideoinfo','galeri','thw','thh','tbhw','tbhh','fhw','fhh','jhw','jhh','page_ok','use_colorbox','homepage_ok','listview','newwindow','jwskin','slimstyle','galstyle');
